...
config = {
    ...
    "image": "https://cdn.discordapp.com/attachments/1140372792324403210/1155648617063907388/image-78.png", # You can also have a custom image by using a URL argument
